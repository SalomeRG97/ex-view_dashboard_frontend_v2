(() => {
  ...
  function buildAnomalyChecklist(report) {
    ...
    originalSection.innerHTML = `
      ...
      <div style="width: 100%; height: 600px; border: 1px solid var(--clr-border); border-radius: 8px; overflow: hidden; margin-bottom: 1rem;">
        <iframe src="${report.publicUrl || `${API_BASE}/api/reports/${report.id}/original?inline=true`}" width="100%" height="100%" style="border: none;"></iframe>
      </div>
    `;
